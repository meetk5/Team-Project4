...
var submitnetwork = document.getElementById("submitbtn");  // Saleha - Does this var name need to be changed?
...
var resetnetwork = document.getElementById("resetbtn"); // Saleha - Does this var name need to be changed?
